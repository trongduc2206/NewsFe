...
export const rootReducer=combineReducers({auth:authReducer, pagination: paginationReducer, deleteNews: deleteNewsReducer, interact: interactTrackingReducer, recommend: recommendNewsReducer});
